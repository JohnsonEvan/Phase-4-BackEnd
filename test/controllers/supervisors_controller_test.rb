...
class SupervisorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supervisor" do
    assert_difference("Supervisor.count") do
      post supervisors_url, params: { supervisor: { date_of_birth: @supervisor.date_of_birth, name: @supervisor.name, position: @supervisor.position, salary: @supervisor.salary } }
    end
  ...
  test "should update supervisor" do
    patch supervisor_url(@supervisor), params: { supervisor: { date_of_birth: @supervisor.date_of_birth, name: @supervisor.name, position: @supervisor.position, salary: @supervisor.salary } }
