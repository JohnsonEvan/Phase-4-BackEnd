...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference("Manager.count") do
      post managers_url, params: { manager: { date_of_birth: @manager.date_of_birth, name: @manager.name, position: @manager.position, salary: @manager.salary } }
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { date_of_birth: @manager.date_of_birth, name: @manager.name, position: @manager.position, salary: @manager.salary } }
